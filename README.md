...
| `forge` | frontend + argus-forge | Turning `/curate` exports into ready-to-run LoRA training configs (kohya / OneTrainer / diffusers) |
...
browser (:3000)  →  Next.js frontend
                         ...
                         └─ /inspect, /config      →  argus-forge (:8103)         →  training configs
